...
public final class CreativeBlocks {
	...
	public static void populate(List<ItemStack> list) {
		...
		add(list, Blocks.COBBLE_NETHERRACK_MOSSY);
		...
		addPainted(list, Blocks.PLANKS_OAK_PAINTED, Blocks.PLANKS_OAK_PAINTED.getLogic());

		add(list, Blocks.STAIRS_PLANKS_OAK);
		addPainted(list, Blocks.STAIRS_PLANKS_PAINTED, Blocks.STAIRS_PLANKS_PAINTED.getLogic());
		add(list, Blocks.SLAB_PLANKS_OAK);
		addPainted(list, Blocks.SLAB_PLANKS_PAINTED, Blocks.SLAB_PLANKS_PAINTED.getLogic());

		add(list, Blocks.FENCE_PLANKS_OAK);
		addPainted(list, Blocks.FENCE_PLANKS_OAK_PAINTED, Blocks.FENCE_PLANKS_OAK_PAINTED.getLogic());

		add(list, Blocks.FENCE_GATE_PLANKS_OAK);
		addPainted(list, Blocks.FENCE_GATE_PLANKS_OAK_PAINTED, Blocks.FENCE_GATE_PLANKS_OAK_PAINTED.getLogic());
		...
		add(list, Blocks.COBBLE_NETHERRACK_IGNEOUS);
...
//		list.add(new ItemStack(Blocks.FLOWER_ORANGE, 1, 96);
		...
		addPainted(list, Blocks.BUTTON_PLANKS_PAINTED, Blocks.BUTTON_PLANKS_PAINTED.getLogic());

		add(list, Blocks.PRESSURE_PLATE_STONE);
		add(list, Blocks.PRESSURE_PLATE_COBBLE_STONE);
		add(list, Blocks.PRESSURE_PLATE_PLANKS_OAK);
		addPainted(list, Blocks.PRESSURE_PLATE_PLANKS_OAK_PAINTED, Blocks.PRESSURE_PLATE_PLANKS_OAK_PAINTED.getLogic());
		...
		addPainted(list, Blocks.LAMP_IDLE, Blocks.LAMP_IDLE.getLogic());
